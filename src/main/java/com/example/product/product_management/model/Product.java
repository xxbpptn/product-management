package com.example.product.product_management.model;
...
import java.time.LocalDateTime; // ใช้ LocalDateTime สำหรับวันที่และเวลา
...
public class Product {
    ...
    // เพิ่ม Getter สำหรับ createdAt และ updatedAt
